//
//  AnimationsListTableViewController.swift
//  AnimationSamples
//
...
class AnimationsListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let screen = self.storyboard?.instantiateViewController(withIdentifier: "Screen\(indexPath.row + 1)") {
